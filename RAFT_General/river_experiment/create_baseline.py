...
class StandardLSTM(nn.Module):
    def __init__(self, input_dim=1, hidden_dim=64, output_dim=6): # 6 outputs for River
...
if __name__ == "__main__":
    ...
    print("Loading scaled data for River baseline...")
    ...
    print("Starting River Baseline training...")
    ...
    torch.save(baseline_model.state_dict(), os.path.join(MODEL_SAVE_PATH, "river_baseline_lstm.pth"))
